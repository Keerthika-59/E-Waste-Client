  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
     const test= await axios.put(
        `http://localhost:5000/auth1/userAct/${id}`,newData
      );
      ...
      <div class="row">
        <div class="holder">
          <form onSubmit={handleContactSubmit}>
            <table width="100%">
              <thead>
                <th class="actHeading">Create User activity</th>
              </thead>
              <tr>
                <td>Biodegradable</td>
                <td>
                      ...
                      <li class="list-group-item">
                        <div class="custom-control custom-checkbox">
                          <input
                            ...
                            type="checkbox"
                            value={type2}
                            onChange={(e) => setType2(e.target.checked)}
                          />
                          <label
                            class="cursor-pointer font-italic d-block custom-control-label"
                            for="customCheck2"
                      ...
                      <li class="list-group-item">
                        <div class="custom-control custom-checkbox">
                          <input
                            ...
                            type="checkbox"
                            value={type3}
                            onChange={(e) => setType3(e.target.checked)}
                          />
                          <label
                            class="cursor-pointer font-italic d-block custom-control-label"
                            for="customCheck3"
                      ...
                      <li class="list-group-item">
                        <div class="custom-control custom-checkbox">
                          <input
                            ...
                            type="checkbox"
                            value={type4}
                            onChange={(e) => setType4(e.target.checked)}
                          />
                          <label
                            class="cursor-pointer font-italic d-block custom-control-label"
                            for="customCheck4"
                      ...
                      <li class="list-group-item rounded-0">
                        <div class="custom-control custom-checkbox">
                          <input
                            ...
                            type="checkbox"
                            value={type5}
                            onChange={(e) => setType5(e.target.checked)}
                          />
                          <label
                            class="cursor-pointer font-italic d-block custom-control-label"
                            for="customCheck5"
