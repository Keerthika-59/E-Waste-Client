                ...
                <div className="row d-flex">
                    ...
                    <div className="col-lg-6">
                        <div className="card2 card border-0 px-4 py-5">
                            ...
                            <div className="row mb-4 px-3"> <small className="font-weight-bold">Already have an account? <Link to= "/RepresentativeLogIn">  <a className="text-danger "> Login  </a> </Link>  </small> </div>
