                    ...
                    <Button
                      ...
                      onClick={() => {
                        Swal.fire({
                          title: "Are you sure?",
                          text:
                            "You will not be able to recover this Representative Details!",
                          icon: "warning",
                          showCancelButton: true,
                          confirmButtonText: "Yes, delete it!",
                          cancelButtonText: "No, keep it",
                          ...
                          if (result.value) {
                              axios.delete(`${APIHelper.API_URL}/${rep._id}`)
                              const removedArr = [...reps].filter(r => r._id !== rep._id);
                              setReps(removedArr);
